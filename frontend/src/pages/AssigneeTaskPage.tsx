          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div className="px-6 pb-6">
              ...
              /* ==================== PDF FORM ==================== */
                ...
                <div className="space-y-4">
                  {/* PDF Document Viewer */}
                  {task.pdfForm?.documentUrl ? (
                    <>
                      <div className="border border-gray-200 rounded-lg overflow-hidden bg-gray-50">
                        <iframe
                          src={task.pdfForm.documentUrl}
                          className="w-full h-[400px]"
                          title="PDF Document"
                        />
                      </div>
                      <a
                        href={task.pdfForm.documentUrl}
                        target="_blank"
                          ...
                          {field.fieldType === 'checkbox' ? (
                            <label className="flex items-center gap-2.5 py-2 px-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                              <input
                                ...
                                onChange={(e) => setFormData(prev => ({ ...prev, [field.fieldId]: e.target.checked ? 'true' : 'false' }))}
                                className="w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                              />
                  ...
                  <Button
                    onClick={() => handleSubmit({ pdfCompleted: true, fieldValues: formData })}
                    disabled={isSubmitting}
                    className="w-full bg-blue-600 hover:bg-blue-700 h-11 text-base"
                  >
                    {isSubmitting && <Loader2 className="w-4 h-4 animate-spin mr-2" />}
